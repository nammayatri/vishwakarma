...
class DatabaseToolset(Toolset):
    name = "database"
    description = (
        "Run read-only SQL queries against ExampleApp databases (BAP/BPP). "
        ...
        return [
            ToolDef(
                ...
                description=(
                    ...
                    "For ClickHouse: use database.table format (e.g., app_db.ride). "
            ...
            ToolDef(
                ...
                description=(
                    ...
                    "(app_db for BAP, provider_db for BPP)."
                ),
                parameters={
                    "type": "object",
                    "properties": {
                        ...
                        "database": {
                            "type": "string",
                            "description": "Database name (for ClickHouse: app_db or provider_db)",
                        },
                    },
                    "required": ["connection"],
                },
            ...
            ToolDef(
                ...
                parameters={
                    ...
                    "properties": {
                        ...
                        "table": {
                            "type": "string",
                            "description": "Table name (e.g., 'ride' or 'app_db.ride')",
                        },
                        "database": {
                            "type": "string",

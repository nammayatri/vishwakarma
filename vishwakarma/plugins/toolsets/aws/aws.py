            ...
            ToolDef(
                ...
                parameters={
                    ...
                    "properties": {
                        "db_instance_identifier": {
                            "type": "string",
                            "description": "DB instance ID e.g. 'app-db-r1'",
                        },
                        "hours": {
                            "type": "integer",
            ...
            ToolDef(
                ...
                parameters={
                    ...
                    "properties": {
                        ...
                        "dimensions": {
                            "type": "array",
                            "description": "Dimension filters e.g. [{\"Name\": \"DBInstanceIdentifier\", \"Value\": \"app-db-r1\"}]",
                            "items": {
                                "type": "object",
                                "properties": {
                                    "Name": {"type": "string"},
            ...
            ToolDef(
                ...
                parameters={
                    ...
                    "properties": {
                        ...
                        "alarm_name_prefix": {
                            "type": "string",
                            "description": "Filter alarms by name prefix e.g. 'app-db'",
                        },
                        "region": {"type": "string"},
                    },
                    "required": [],
            ...
            ToolDef(
                ...
                parameters={
                    ...
                    "properties": {
                        "log_group_name": {
                            "type": "string",
                            "description": "Log group name e.g. '/aws/rds/instance/app-db-r1/slowquery'",
                        },
                        "log_stream_name": {
                            "type": "string",
            ...
            ToolDef(
                ...
                parameters={
                    ...
                    "properties": {
                        "cluster_id": {
                            "type": "string",
                            "description": "Specific cluster ID e.g. 'app-redis-cluster'. Omit to list all.",
                        },
                        "region": {"type": "string"},
                    },
                    "required": [],

...
| **Where to check** | Writer instances (customer-w1, provider-db-w3) | Reader instances (driver-r1, app-db-r1, customer-r3) |
...
- Aurora cluster identifiers: `provider-db-cluster` (driver), `app-db-cluster` (customer)

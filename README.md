...
flowchart TD
    ...
    subgraph CATALOG[agents.json — 6 runbooks]
        ...
        R5[ny-sre-sev2-alerts<br/>keywords: protocol, acme, allocator]
...
- **Slack bot** — `@sage debug <question>` for on-demand investigations; casual questions answered with tone-matching
